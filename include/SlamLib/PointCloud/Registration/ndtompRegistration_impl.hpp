 ...
 */
#pragma once 
#include "SlamLib/PointCloud/Registration/ndtompRegistration.h"
...
NdtOmpRegistration<_PointType>::NdtOmpRegistration(RegistrationPtr ptr, 
 ...
 */
template<typename _PointType>
void NdtOmpRegistration<_PointType>::SetInputSource(
 ...
 */
template<typename _PointType>
void NdtOmpRegistration<_PointType>::SetInputTarget(
...
template<typename _PointType>
void NdtOmpRegistration<_PointType>::SetMaxIteration(uint16_t const& n) {
}

template<typename _PointType>
void NdtOmpRegistration<_PointType>::SetNormIteration(uint16_t const& n) {
}
 ...
 */
template<typename _PointType>
bool NdtOmpRegistration<_PointType>::Solve(Eigen::Isometry3d& T) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template<typename _PointType>
bool NdtOmpRegistration<_PointType>::HasConverged() {
...
NdtOmpRegistration<_PointType>::GetRegistrationResult() const {
}

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template<typename _PointType>
std::vector<std::string> NdtOmpRegistration<_PointType>::GetUsedPointsName() {
